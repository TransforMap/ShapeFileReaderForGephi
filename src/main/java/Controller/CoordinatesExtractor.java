...
class CoordinatesExtractor {
    ...
    CoordinatesExtractor(ContentFeatureCollection featureCollection) {
        this.featureCollection = featureCollection;
    }

    public void extract(boolean testOneState) throws IOException {
        ...
        while (iterator.hasNext()) {
            ...
            for (Property p : properties) {
                if (testOneState && counterStates != 1) {
                    continue;
                }
